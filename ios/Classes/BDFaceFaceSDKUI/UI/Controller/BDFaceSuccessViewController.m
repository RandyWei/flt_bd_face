...
//    [self.view addSubview:liveScoreLabel];
    ...
    [btnFirst setImage:[[UIImage alloc] initWithContentsOfFile:[ImageBundle pathForResource:@"btn_main_normal" ofType:@"png"]] forState:UIControlStateNormal];
    ...
    [btnSecond setImage:[[UIImage alloc] initWithContentsOfFile:[ImageBundle pathForResource:@"btn_less_normal" ofType:@"png"]] forState:UIControlStateNormal];
